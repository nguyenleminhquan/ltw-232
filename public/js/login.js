            ...
            success: function (data) {
                ...
                if (res[0] == 'false') {
                    if (res[1] == 'null') {
                        ...
                        $('#content_login').html("<p class='x51' style='display:inline'>Tài khoản của bạn không được phép đăng nhập vì vi phạm quy định của website. Vui lòng liên hệ quản trị viên: admin@gmail.com</p>"); 
                    }
                } 
                else {
